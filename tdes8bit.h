...
*/
unsigned char perm_input[8]; // global variable
unsigned char pre_output[8]; // global variable
unsigned char k[3][16][6]; // global variable
unsigned char l[4]; // global variable
unsigned char r[4]; // global variable
unsigned char b[8]; // global variable
unsigned char s[4]; // global variable
unsigned char f[4]; // global variable
unsigned char c[4]; // global variable
unsigned char d[4]; // global variable
unsigned char cd[7]; // global variable
////////////////////////////////////////////////////////////////////////////////
...
*/
extern unsigned char perm_input[8]; // global variable
extern unsigned char pre_output[8]; // global variable
extern unsigned char k[3][16][6]; // global variable
extern unsigned char l[4]; // global variable
extern unsigned char r[4]; // global variable
extern unsigned char b[8]; // global variable
extern unsigned char s[4]; // global variable
extern unsigned char f[4]; // global variable
extern unsigned char c[4]; // global variable
extern unsigned char d[4]; // global variable
extern unsigned char cd[7]; // global variable
////////////////////////////////////////////////////////////////////////////////
